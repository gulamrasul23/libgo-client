...
const Home = () => {
  ...
  return (
    <div className="text-base-content overflow-hidden">
      ...
      {/* --- 2. LATEST BOOKS SECTION --- */}
      <BookCard books={books}></BookCard>

      {/* --- 3. EXTRA SECTION: GENRES (Responsive Grid) --- */}
     <Type types={types}></Type>
      {/* --- 4. WHY CHOOSE US (Animated Feature Cards) --- */}
      ...
      {/* --- 5. COVERAGE SECTION (Visual Map) --- */}
      <Coverage></Coverage>

      {/* --- 6. EXTRA SECTION: NEWSLETTER CTA --- */}
